...
import {
  ...
  Music, SlidersHorizontal, ArrowUpDown, Filter, User, ShieldCheck, QrCode, Settings, LogOut, Calendar
} from 'lucide-react';
...
import { MusiciansPage } from '../Musicians/MusiciansPage';
import { SettingsPage } from '../Settings/SettingsPage';
import { SongEditorPage } from '../Songs/SongEditorPage';
...
export const FoldersPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col p-2 sm:p-4 h-full w-full mx-auto">
      ...
      <div className="bg-m3-card border border-m3-border rounded-[32px] shadow-2xl shadow-black/10 overflow-hidden flex flex-col flex-1 h-full transition-all duration-300">
        
        {/* Explorer Address Bar & Toolbar */}
        <div className="p-4 bg-m3-sidebar/40 border-b border-m3-border/50 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-[280px]">
            ...
            {/* Address Path Bar */}
            <div className="flex-1 flex items-center gap-2 px-4 py-2.5 bg-m3-bg border border-m3-border rounded-2xl text-[13px] overflow-x-auto select-none hide-scrollbar shadow-inner">
              <button
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-64 bg-m3-sidebar/30 border-r border-m3-border p-4 hidden md:flex flex-col gap-1 select-none shrink-0 overflow-y-auto transition-colors duration-300">
          ...
          <div className="flex-1 flex flex-col relative bg-white dark:bg-slate-900 overflow-hidden">
            {isSongEditorView ? (
              ...
              <div className="w-full h-full overflow-y-auto">
                <ServicesPage hideHeader searchQuery={searchQuery} />
              </div>
            ) : isMusiciansView ? (
              <div className="w-full h-full overflow-y-auto">
                <MusiciansPage hideHeader />
              </div>
            ) : isSettingsView ? (
              <div className="w-full h-full overflow-y-auto">
                ...
                {filteredFiles.map((song) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {song.key && (
                        <span className="text-[10px] font-black text-m3-primary bg-m3-primary/10 px-2 py-0.5 rounded-lg mt-1.5 uppercase tracking-widest">
                          {song.key}
                        </span>
                      )}
